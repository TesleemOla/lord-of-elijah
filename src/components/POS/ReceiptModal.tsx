        ...
        >
          ...
          <div className="border-b-2 border-indigo-600 pb-2 mb-3 flex justify-between items-start">
            <div>
              ...
              <div className="flex items-center gap-2 mt-0.5">
                ...
                <p className="text-[10px] text-gray-500 font-normal tracking-wide uppercase">Premium Management System</p>
              </div>
            </div>
            <div className="text-right">
              ...
              <p className="text-[10px] text-gray-400 font-normal uppercase tracking-tight">REF: #{transaction._id?.slice(-8).toUpperCase()}</p>
            </div>
          </div>
          ...
          <div className="flex justify-between mb-4 text-xs">
            ...
            <div className="text-right">
              ...
              <p className="text-[10px] text-gray-500 mt-0.5 font-normal">Status: <span className={`font-bold uppercase ${
                transaction.type === 'SALE' 
          ...
          <div className="flex justify-between items-start pt-2 border-t border-gray-100">
             <div className="max-w-[180px]">
                <p className="text-[9px] leading-tight text-gray-400 font-normal">This confirms transaction status. For queries, visit the authorized unit.</p>
             </div>
              <div className="space-y-1 w-full max-w-[180px]">
                ...
                <div className={`flex justify-between items-center p-1.5 rounded-sm ${
